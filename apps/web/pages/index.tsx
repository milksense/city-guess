...
const IndexPage = () => {
	...
	useEffect(() => {
		const timeZone: string = Intl.DateTimeFormat()
			.resolvedOptions()
		...
		const timer = setTimeout(() => {
			fetch(
				`https://api.teleport.org/api/urban_areas/slug:${city.replace(
					'_',
					' '
				)}/images/`
			)
				...
				<Card css={{ px: '$4', mt: 20, mb: 20 }}>
					...
					<Card.Footer>
						<Link
							color="primary"
							target="_blank"
							href="https://github.com/milksense/city-guess"
						>
